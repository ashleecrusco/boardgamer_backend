...
codenames = Boardgame.create(slug: 'codenames', name: 'Codenames', description:"Two rival spymasters know the secret identities of 25 agents. Their teammates know the agents only by their CODENAMES.
...
catan = Boardgame.create(slug: 'catan', name: 'Catan', description:"ruins friendships", category: '4X', image_url: 'https://cf.geekdo-images.com/images/pic2419375_md.jpg', manufacturer: 'Catan Studio ' )
